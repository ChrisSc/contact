...
- **`perks.ts`** — Pure perk store functions: `getPerkDefinition`, `purchasePerk`, `removeFromInventory`, `getInventoryBySlot`, `generateInstanceId`. Returns new `PlayerState` (immutable pattern).
